...
public class SingletonMain implements Closeable {
    ...
    /**
     * Legge un intero dalla console finché non corrisponde a uno dei valori possibili.
     *
     * @param possibleValues un array di valori interi validi.
     * @return l'intero inserito dall'utente che corrisponde a uno dei valori possibili.
     */
