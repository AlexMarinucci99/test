...
/**
 * Classe singleton che implementa FileService.
...
public class FileServiceImpl implements FileService {
     ...
     * Garantisce che le directory necessarie esistano.
     */
    private FileServiceImpl() {
        ...
        // Assicura che la directory 'saves/' esista
    ...
    /**
     * Restituisce l'istanza singleton di FileServiceImpl.
     *
     * @return l'istanza di FileServiceImpl.
     */
    ...
    public int getNextGameNumber() {
        ...
        if (Files.exists(counterFile)) {
            try {
                ...
                System.out.println("Errore durante la lettura del contatore di partite: " + e.getMessage());
            }
        }
        ...
        try {
            ...
            System.out.println("Errore durante la scrittura del contatore di partite: " + e.getMessage());
        }
        return gameNumber;
    }
    ...
    public void writeLog(String data) {
        ...
        try (FileWriter writer = new FileWriter(logFilePath.toFile(), true);
            ...
            // Suddividi 'data' in linee separate
